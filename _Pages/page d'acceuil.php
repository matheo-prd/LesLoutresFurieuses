...
<body>
    <header>
        <table class="tableindex">
            <thead>
                <tr>
                    <th colspan="2"><a href="./Index.html"><img src="./Img/logo/banderole_logo_transparent.png" width="40%" height="40%"></a></th>
                    <th colspan="2"><p>Voir les trajets disponible</p></th>
                    <th colspan="2"><p>Ajouter un nouveau trajet</p></th>
                    <th colspan="2"><img src="./Img/logo/blank.png" width="50%" height="50%"></th>
                    <th class="tableuser" colspan="2"><p> 
    ...
    <section>
        <img src="./Img/banderole.gif" width="100%" height="100%">
    </section>
    <br>
